...
from datumagro.apps.cadastros.models import Cliente, Propriedade, Animal, Lote, Piquete
from datumagro.apps.financeiro.models import CategoriaFinanceira, FluxoCaixa
from datumagro.apps.inteligencia.models import TipoAlerta, Alerta
...
📊 Dados criados:
   ...
   - {len(lotes)} lotes
   - {len(animals_data)} animais
   - {len(categorias_data)} categorias financeiras
