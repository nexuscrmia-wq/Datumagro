...
def versao_app(request):
    ...
    versao = '1.6.6'  # atualizar aqui a cada release
    ...
    return Response({
        ...
        'novidades': os.getenv('UPDATE_NOVIDADES', 'Data de nascimento no cadastro de animais corrigida. Sincronização entre dispositivos (tablet e celular) agora automática ao abrir. Foto de perfil temporariamente desativada.'),
    })
