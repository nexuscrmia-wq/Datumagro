...
class RastreabilidadeTest(TestCase):
    ...
    def setUp(self):
        ...
        self.cliente = Cliente.objects.create(
            nome_empresa='Fazenda Rastreio',
            cpf_cnpj='12345678000191',
            email_contato='rastreio@fazenda.com'
        )
        self.propriedade = Propriedade.objects.create(cliente=self.cliente, nome_propriedade='Sede Rastreio')
        self.animal = Animal.objects.create(propriedade=self.propriedade, brinco='RASTREIO-01', raca='NELORE', sexo='M',
